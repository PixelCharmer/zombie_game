...
export default function Room2() {
    ...
    const handleSubmit = () => {
        ...
        if (isCorrect) {
            setTimeout(() => navigate('/room3'), 2000);
        }
    };
        ...
        >
            ...
            {!showPuzzle && (
                <div
                    ...
                    style={{
                        position: 'absolute', top: '51%', left: '60%',
            ...
            {showPuzzle && (
                <div
                    ...
                    style={{
                        ...
                        padding: '2rem', border: '2px solid lime',
                        boxShadow: '0 0 10px lime', zIndex: 2,
                    }}
                >
                    ...
                    <div className="buttons mt-4">
                        ...
                        <button className="button is-danger" onClick={() => setShowPuzzle(false)}>Close Puzzle</button>
                    </div>
